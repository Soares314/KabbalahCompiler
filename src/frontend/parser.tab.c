...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_if_prefix = 35,                 /* if_prefix  */
  YYSYMBOL_loop_prefix = 36,               /* loop_prefix  */
  YYSYMBOL_tipo = 37,                      /* tipo  */
  YYSYMBOL_statement = 38,                 /* statement  */
  YYSYMBOL_39_1 = 39,                      /* @1  */
  YYSYMBOL_condicao = 40,                  /* condicao  */
...
{
       0,    82,    82,    86,    87,    92,   105,   120,   121,   122,
     123,   129,   150,   170,   175,   175,   184,   192,   200,   208,
     219,   240,   259,   278,   297,   300,   313,   321
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_RETURN", "TYPE_VOID", "TYPE_INT", "TYPE_CHAR", "TYPE_FLOAT",
  "TYPE_LONG", "KW_SIZEOF", "KW_IF", "KW_ELSE", "KW_FOR", "KW_FOREACH",
  "ASSIGN", "SEMICOLON", "OP_EQ", "OP_LT", "OP_GT", "IDENTIFIER", "NUM",
  "NUM_FLOAT", "KW_WHILE", "'+'", "'-'", "'*'", "'/'", "'('", "')'", "'{'",
  "'}'", "$accept", "program", "statements", "if_prefix", "loop_prefix",
  "tipo", "statement", "@1", "condicao", "expr", YY_NULLPTR
};
...
{
      72,   -23,   -23,   -23,   -23,     6,    -4,     8,    18,    72,
     -11,    11,    22,   -23,    17,    17,    17,   -23,   -23,    72,
      72,    28,   -23,   -23,   -23,    17,    19,    79,   -10,    20,
      24,    45,    17,   -17,   -23,    17,    17,    17,    17,    17,
      17,    17,   -23,   -23,    34,   -23,    61,   -23,    75,    75,
      75,   -22,   -22,   -23,   -23,   -23,   -23,    31,    72,    51,
     -23
};
...
{
       0,     7,     9,     8,    10,     0,     0,     0,     0,     2,
       0,     0,     0,     3,     0,     0,     0,     1,     4,     0,
       0,     0,    25,    26,    27,     0,     0,     0,     0,     0,
       0,     0,     0,     0,     5,     0,     0,     0,     0,     0,
       0,     0,    12,     6,    13,    16,     0,    24,    17,    18,
      19,    20,    21,    22,    23,    14,    11,     0,     0,     0,
      15
};
...
{
     -23,   -23,   -18,   -23,   -23,   -23,    -9,   -23,    47,   -12
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     8,     9,    10,    11,    12,    13,    57,    26,    27
};
...
{
      18,    30,    31,    28,    40,    41,    42,    38,    39,    40,
      41,    15,    47,    33,    38,    39,    40,    41,    17,    19,
      46,    18,    18,    48,    49,    50,    51,    52,    53,    54,
       1,     2,     3,     4,    14,     5,    16,    22,    23,    24,
      59,    20,    21,    32,     6,    25,    55,     7,    34,    43,
      18,     1,     2,     3,     4,    44,     5,     1,     2,     3,
       4,    58,     5,    29,     0,     6,     0,     0,     7,     0,
       0,     6,     0,     0,     7,     0,    45,    56,     1,     2,
       3,     4,    60,     5,     0,    38,    39,    40,    41,     0,
       0,     0,     6,     0,     0,     7,    35,    36,    37,    38,
      39,    40,    41,    38,    39,    40,    41
};

static const yytype_int8 yycheck[] =
{
       9,    19,    20,    15,    26,    27,    16,    24,    25,    26,
      27,    15,    29,    25,    24,    25,    26,    27,     0,    30,
      32,    30,    31,    35,    36,    37,    38,    39,    40,    41,
       6,     7,     8,     9,    28,    11,    28,    20,    21,    22,
      58,    30,    20,    15,    20,    28,    12,    23,    29,    29,
      59,     6,     7,     8,     9,    31,    11,     6,     7,     8,
       9,    30,    11,    16,    -1,    20,    -1,    -1,    23,    -1,
      -1,    20,    -1,    -1,    23,    -1,    31,    16,     6,     7,
       8,     9,    31,    11,    -1,    24,    25,    26,    27,    -1,
      -1,    -1,    20,    -1,    -1,    23,    17,    18,    19,    24,
...
{
       0,     6,     7,     8,     9,    11,    20,    23,    33,    34,
      35,    36,    37,    38,    28,    15,    28,     0,    38,    30,
      30,    20,    20,    21,    22,    28,    40,    41,    41,    40,
      34,    34,    15,    41,    29,    17,    18,    19,    24,    25,
      26,    27,    16,    29,    31,    31,    41,    29,    41,    41,
      41,    41,    41,    41,    41,    12,    16,    39,    30,    34,
      31
};
...
#line 1198 "parser.tab.c"
  ...
  case 6: /* loop_prefix: KW_WHILE '(' condicao ')'  */
#line 105 "parser.y"
                              {
        ASTNode* node_break = new_node(new_label(), "break", NULL, NULL);
        ASTNode* node_continue = new_node(new_label(), "continue", NULL, NULL);

        (yyval.node) = new_node((yyvsp[-3].str), "while", node_break, node_continue);
        
        printf("\nAST de Loop:\n");
        print_ast((yyvsp[-1].node), 0);

        emit_label(node_continue->value);
        emit_if_false((yyvsp[-1].node)->code, node_break->value);
    }
...
#line 1227 "parser.tab.c"
  ...
  case 9: /* tipo: TYPE_CHAR  */
#line 122 "parser.y"
               { (yyval.str) = "char"; }
#line 1233 "parser.tab.c"
    break;

  case 10: /* tipo: TYPE_LONG  */
#line 123 "parser.y"
               { (yyval.str) = "long"; }
#line 1239 "parser.tab.c"
    break;

  case 11: /* statement: tipo IDENTIFIER ASSIGN expr SEMICOLON  */
#line 129 "parser.y"
                                          {
        ...
        if (strcmp((yyvsp[-4].str), (yyvsp[-1].node)->data_type) != 0) {
            printf("Erro Semântico: Tipo '%s' não é compatível com '%s'.\n", (yyvsp[-1].node)->data_type, (yyvsp[-4].str));
            exit(1);
        }
        add_symbol((yyvsp[-4].str), (yyvsp[-3].str));

        ASTNode* id_node = new_node((yyvsp[-3].str), "identifier", NULL, NULL);
        ASTNode* root    = new_node("=", "assign", id_node, (yyvsp[-1].node));
...
#line 1263 "parser.tab.c"
  ...
  case 12: /* statement: IDENTIFIER ASSIGN expr SEMICOLON  */
#line 150 "parser.y"
                                       {
        ...
        if (strcmp(sym->type, (yyvsp[-1].node)->data_type) != 0) {
            printf("Erro Semântico: Impossível converter '%s' para '%s'!\n", (yyvsp[-1].node)->data_type, sym->type);
            exit(1);
        }
        ASTNode* id_node = new_node((yyvsp[-3].str), "identifier", NULL, NULL);
        ASTNode* root    = new_node("=", "assign", id_node, (yyvsp[-1].node));
...
#line 1287 "parser.tab.c"
  ...
  case 13: /* statement: if_prefix '{' statements '}'  */
#line 170 "parser.y"
                                   {
        // IF sem ELSE
...
#line 1307 "parser.tab.c"
  ...
  case 15: /* statement: if_prefix '{' statements '}' KW_ELSE @1 '{' statements '}'  */
#line 180 "parser.y"
                         {
        emit_label((yyvsp[-3].str));
    }
#line 1315 "parser.tab.c"
  ...
  case 16: /* statement: loop_prefix '{' statements '}'  */
#line 184 "parser.y"
                                     {
        emit_goto((yyvsp[-3].node)->right->value);
        emit_label((yyvsp[-3].node)->left->value);
    }
#line 1324 "parser.tab.c"
    break;

  case 17: /* condicao: expr OP_EQ expr  */
#line 192 "parser.y"
                    {
        ASTNode* node = new_node("==", "relacional", (yyvsp[-2].node), (yyvsp[0].node));
        char* temp = new_temp();
        emit(temp, (yyvsp[-2].node)->code, "==", (yyvsp[0].node)->code);
...
#line 1337 "parser.tab.c"
  ...
  case 18: /* condicao: expr OP_LT expr  */
#line 200 "parser.y"
                    {
        ASTNode* node = new_node("<", "relacional", (yyvsp[-2].node), (yyvsp[0].node));
        char* temp = new_temp();
...
#line 1350 "parser.tab.c"
  ...
  case 19: /* condicao: expr OP_GT expr  */
#line 208 "parser.y"
                    {
        ASTNode* node = new_node(">", "relacional", (yyvsp[-2].node), (yyvsp[0].node));
        char* temp = new_temp();
...
#line 219 "parser.y"
                  {
        // --- CHECAGEM DE TIPO ---
        if (strcmp((yyvsp[-2].node)->data_type, (yyvsp[0].node)->data_type) != 0) {
        ...
        if (strcmp((yyvsp[-2].node)->data_type, "float") == 0 || strcmp((yyvsp[0].node)->data_type, "float") == 0) {
            printf("Erro: Operações com float ainda não são suportadas!\n");
            exit(1);
        }
        
        ASTNode* node = new_node("+", "op", (yyvsp[-2].node), (yyvsp[0].node));
        strcpy(node->data_type, (yyvsp[-2].node)->data_type); // Propaga o tipo para cima
...
#line 240 "parser.y"
        ...
        if (strcmp((yyvsp[-2].node)->data_type, "float") == 0) {
            printf("Erro: Operações com float ainda não são suportadas!\n");
            exit(1);
        }
        
        ASTNode* node = new_node("-", "op", (yyvsp[-2].node), (yyvsp[0].node));
        strcpy(node->data_type, (yyvsp[-2].node)->data_type);
...
#line 297 "parser.y"
                 {
        (yyval.node) = (yyvsp[-1].node); // Os parênteses apenas repassam o nó inteiro, já com o tipo correto
    }
...
#line 1500 "parser.tab.c"
  ...
  case 27: /* expr: NUM_FLOAT  */
#line 321 "parser.y"
              {
        ASTNode* node = new_node((yyvsp[0].str), "literal", NULL, NULL);
